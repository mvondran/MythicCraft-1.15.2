...
public class UnderworldChunkGenerator extends NoiseChunkGenerator<UnderworldGenSettings> {
	...
	public UnderworldChunkGenerator(IWorld worldIn, BiomeProvider provider, UnderworldGenSettings settingsIn) {
