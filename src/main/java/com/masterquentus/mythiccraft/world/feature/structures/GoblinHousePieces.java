...
public class GoblinHousePieces {
 
	private static final ResourceLocation Part_1 = new ResourceLocation(MythicCraft.MOD_ID, "goblin_house");
	...
	public static class Piece extends TemplateStructurePiece {
		...
		public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos,
				Rotation rotationIn) {
			super(FeatureInit.GOBLINHOUSE_PIECE, 0);
			this.resourceLocation = resourceLocationIn;
			BlockPos blockpos = GoblinHousePieces.OFFSET.get(resourceLocation);
		...
		public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
			super(FeatureInit.GOBLINHOUSE_PIECE, tagCompound);
		...
		public boolean create(IWorld worldIn, ChunkGenerator<?> chunkGeneratorIn, Random randomIn,
			...
			PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation)
					.setMirror(Mirror.NONE);
			BlockPos blockpos = GoblinHousePieces.OFFSET.get(this.resourceLocation);
